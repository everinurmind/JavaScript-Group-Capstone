  ...
  const fetchPokemons = async (number) => {
    ...
    pokemonData.forEach((pokemon) => {
      ...
      if (id == pokemon.id) {
        ...
        inputreservation.append(
          namereservation, datereservationstart, datereservationend, reservebutton,
        );
        addareservation.append(
          addareservationtitle, inputreservation,
        );

        maincontainer.append(
          closecontainer, closeandimage, pokemoname, characteristics, reservations, addareservation,
        );
